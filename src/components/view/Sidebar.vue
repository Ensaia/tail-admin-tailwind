        ...
        <ul class="mb-6 flex flex-col gap-1.5">
          ...
          <li>
            <a
              ...
              href="#"
              x-on:click.prevent="selected = (selected === 'Dashboard' ? '':'Dashboard')"
              x-bind:class="{ 'bg-graydark dark:bg-meta-4': (selected === 'Dashboard') || (page === 'analytics' || page === 'ecommerce') }"
            >
              <svg
                class="fill-current"
                width="18"
              ...
              <svg
                ...
                x-bind:class="{ 'rotate-180': (selected === 'Dashboard') }"
                width="20"
                height="20"
                viewBox="0 0 20 20"
                fill="none"
            ...
            >
              <ul class="mt-4 mr-5.5 flex flex-col gap-2.5 pl-6">
                <li>
                  <a
                    class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                    href="index.html"
                    x-bind:class="page === 'analytics' && '!text-white'"
                    >Analytics</a
                  >
                </li>
              </ul>
